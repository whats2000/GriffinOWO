...
register("chat", () => {
    ...
    if (Settings.kuudraShowPhrase)
        Client.Companion.showTitle(`&6Get Ready`, "", 5, 25, 5);
...
register("chat", () => {
    phase = 1;
    if (Settings.kuudraShowPhrase)
        Client.Companion.showTitle(`&6Supply Spawn`, "", 5, 25, 5);
...
register("chat", () => {
    phase = 2;
    if (Settings.kuudraShowPhrase)
        Client.Companion.showTitle(`&6Supply Done`, "", 5, 25, 5);
...
register("chat", () => {
    phase = 3;
    if (Settings.kuudraShowPhrase)
        Client.Companion.showTitle(`&6Build Done`, "", 5, 25, 5);
...
register("chat", () => {
    phase = 4;
    if (Settings.kuudraShowPhrase)
        Client.Companion.showTitle(`&6Hit Phrase Done`, "", 5, 25, 5);
