...
register("chat", () => {
    ...
    setTimeout(() => {
        ...
        ChatLib.chat("&c - &eFix the wrong waypoint in Mage and Berserk");
        ChatLib.chat("");
        ChatLib.chat("&b&l                Change");
        ChatLib.chat("&d = &eRemove Dragon Timer auto adjust (By some packet lost bug, will still need some change to make it consistent)");
        ChatLib.chat("&r&r&b&m-----------------------------------------------------");
    }, 1000);
